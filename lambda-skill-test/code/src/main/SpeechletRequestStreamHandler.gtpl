 ...
 * "${group}.${lambdaHandlerClass}" For this to work, you'll also need to build
 * this project using the {@code lambda-compile} Ant task and upload the resulting zip file to power
 * your function.
 */
public final class ${lambdaHandlerClass} extends SpeechletRequestStreamHandler {
    private  static final Logger log = LoggerFactory.getLogger(${lambdaHandlerClass}.class)
    ...
    static {
        ...
        try {
            InputStream stream = ${speechletClassName}.class.getClassLoader()getResourceAsStream("springSocial.properties")
